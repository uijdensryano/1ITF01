    ...
    public class MathParser
    {
        ...
        private double MathParserLogic(List<string> tokens)
        {
            ...
            for (var i = 0; i < tokens.Count; i++)
            {
                ...
                {
                    tokens[i] = LocalVariables[tokens[i]].ToString(System.Globalization.CultureInfo.InvariantCulture);
                }
            }
            ...
            while (tokens.IndexOf("(") != -1)
            {
                ...
                if (open >= close)
                {
                    throw new ArithmeticException("No closing bracket/parenthesis. Token: " + open.ToString(System.Globalization.CultureInfo.InvariantCulture));
                }
                ...
                if (LocalFunctions.Keys.Contains(functionName))
                {
                    if (roughExpr.Contains(","))
                    {
                        ...
                        tmpResult = double.Parse(LocalFunctions[functionName](args.ToArray()).ToString(System.Globalization.CultureInfo.InvariantCulture), System.Globalization.CultureInfo.InvariantCulture);
                    }
                    else
                    {
                        ...
                        else
                        {
                            ...
                            }).ToString(System.Globalization.CultureInfo.InvariantCulture), System.Globalization.CultureInfo.InvariantCulture);
                        }
                    }
                }
                else
                ...
                tokens[open] = tmpResult.ToString(System.Globalization.CultureInfo.InvariantCulture);
        ...
        private double BasicArithmeticalExpression(List<string> tokens)
        {
            ...
            {
                case 1:
                    if (!double.TryParse(tokens[0], NumberStyles.Number, System.Globalization.CultureInfo.InvariantCulture, out token0))
                    {
                ...
                case 2:
                    ...
                    if (op == "-" || op == "+")
                    {
                        ...
                        if (!double.TryParse(first + tokens[1], NumberStyles.Number, System.Globalization.CultureInfo.InvariantCulture, out token1))
                        {
                    ...
                    if (!double.TryParse(tokens[1], NumberStyles.Number, System.Globalization.CultureInfo.InvariantCulture, out token1))
                    {
            ...
            foreach (var op in Operators)
            {
                ...
                while ((opPlace = tokens.IndexOf(op.Key)) != -1)
                {
                    ...
                    if (!double.TryParse(tokens[opPlace + 1], NumberStyles.Number, System.Globalization.CultureInfo.InvariantCulture, out rhs))
                    {
                    ...
                    if (op.Key == "-" && opPlace == 0)
                    {
                        ...
                        tokens[0] = result.ToString(System.Globalization.CultureInfo.InvariantCulture);
                    ...
                    else
                    {
                        ...
                        if (!double.TryParse(tokens[opPlace - 1], NumberStyles.Number, System.Globalization.CultureInfo.InvariantCulture, out lhs))
                        {
                            throw new MathParserException("local variable " + tokens[opPlace - 1] + " is undefined");
                        }

                        var result = op.Value(lhs, rhs);
                        tokens[opPlace - 1] = result.ToString(System.Globalization.CultureInfo.InvariantCulture);
